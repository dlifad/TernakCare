...
export default function Profile({ auth }) {
    ...
    const [currentPhotoUrl, setCurrentPhotoUrl] = useState(
        "/storage/assets/default-avatar.png",
    );
    ...
    const handleSubmit = (e) => {
        ...
        window.axios
            .post(route("farmer.profile.update"), formData, {
                headers: {
    ...
    const handlePasswordSubmit = (e) => {
        ...
        window.axios
            .post(route("farmer.profile.update-password"), {
                            ...
                            <div className="relative mb-4 sm:mb-0 sm:mr-6">
                                ...
                                {isEditing && (
                                    <label
                                        ...
                                        className="absolute bottom-0 right-0 p-1 bg-white rounded-full shadow-sm text-neutral-dark hover:text-primary cursor-pointer"
                                    >
                                        <Camera size={16} />
                                        <input
                                            id="photo-upload"
