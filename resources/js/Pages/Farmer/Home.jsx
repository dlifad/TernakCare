            ...
            <div className="relative bg-primary-light rounded-xl overflow-hidden">
                ...
                <div className="relative p-6 md:p-10 max-w-4xl">
                    ...
                    <p className="text-neutral-dark text-lg mb-6">
                        Platform terpadu untuk kebutuhan peternakan Anda.
                        Konsultasi dengan dokter hewan, jelajahi pasar ternak,
                        dan dapatkan informasi terkini.
                    </p>
                    ...
                    <div className="flex items-start gap-3 p-3 border-b border-neutral-lightest">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-neutral">
                                Dokter Ani telah menyetujui permintaan
                                konsultasi Anda pada 8 Mei 2025, pukul 10:00
                            </p>
            ...
            <div className="my-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    >
                        ...
                        <h3 className="font-medium text-center text-neutral-darkest">
                            Panggil Dokter
                        </h3>
                        <p className="text-sm text-center text-neutral mt-1">
                            Chat, Video Call, atau Kunjungan
                        </p>
                    </Link>
            ...
            <div className="my-8 bg-neutral-lightest rounded-xl p-6">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex gap-3">
                        <Link
                            href="#"
                            className="px-4 py-2 bg-white text-primary border border-primary rounded-lg hover:bg-primary-light transition duration-300"
                        >
                            Panduan Penggunaan
                        </Link>
                        <a
