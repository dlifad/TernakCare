...
export default function DoctorConsultation({ consultations = [] }) {
    ...
    const mockConsultations = [
        {
            ...
            complaint:
                "Sapi tidak mau makan selama 2 hari terakhir dan terlihat lesu",
            image: null,
        },
        {
            id: 2,
            ...
            complaint:
                "Kambing mengalami diare dan tidak aktif seperti biasanya",
            image: null,
        },
        {
            id: 3,
    ...
    const allConsultations =
        consultations.length > 0 ? consultations : mockConsultations;
            ...
            <div className="py-6 px-4 lg:px-8">
                <div className="mb-6">
                    ...
                    <p className="text-neutral-dark mt-1">
                        Kelola permintaan konsultasi dari peternak
                    </p>
                </div>
