                            ...
                            <div className="divide-y divide-neutral-light">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            <h3 className="text-sm font-medium text-neutral-darkest">
                                                Chat dengan Richard Cooper
                                            </h3>
                                            <p className="text-xs text-neutral mt-1">
                                                09:30 - Nutrisi Sapi Perah
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="p-6 flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            <h3 className="text-sm font-medium text-neutral-darkest">
                                                Panggilan Video dengan John Doe
                                            </h3>
                                            <p className="text-xs text-neutral mt-1">
                                                13:00 - Pemeriksaan Kesehatan
                                                Sapi Perah
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="p-6 flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            <h3 className="text-sm font-medium text-neutral-darkest">
                                                Kunjungan ke Peternakan Alice
                                                Smith
                                            </h3>
                                            <p className="text-xs text-neutral mt-1">
                                                15:30 - Penilaian Kesehatan
                                                Unggas
                                            </p>
                                        </div>
                                    </div>
