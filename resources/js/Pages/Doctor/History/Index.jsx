...
export default function DoctorHistory({ history = [] }) {
    ...
    const mockHistory = [
        {
            ...
            complaint:
                "Beberapa ayam mengalami gejala flu dan produksi telur menurun",
            diagnosis:
                "Infeksi saluran pernapasan (CRD - Chronic Respiratory Disease)",
            prescription:
                "Antibiotik Enrofloxacin 10mg/kg selama 5 hari, tambahan vitamin dan probiotik",
        ...
        },
        {
            ...
            complaint:
                "Sapi mengalami pembengkakan pada kaki dan kesulitan berjalan",
            diagnosis: "Laminitis dan kemungkinan infeksi kuku",
            prescription:
                "Anti-inflamasi Flunixin 2.2mg/kg, antibiotik Ceftiofur 1mg/kg selama 3 hari",
        ...
        },
        {
            ...
            prescription:
                "Obat cacing Albendazole 10mg/kg dosis tunggal, suplemen elektrolit",
        ...
        },
        {
            ...
            prescription:
                "Prosedur bantuan kelahiran dilakukan, antibiotik Penicillin 22,000 IU/kg selama 5 hari",
    ...
    const filteredHistory = allHistory.filter((record) => {
        const matchesTypeFilter =
            filter === "all" || record.consultation_type === filter;
        const matchesDateFilter =
            dateFilter === "all" || filterByDate(record.date, dateFilter);
        const matchesSearch =
            record.patient_name
                .toLowerCase()
                            ...
                            filteredHistory.map((record) => (
                                ...
                                >
                                        ...
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-1 flex items-center space-x-2">
                                                    <span
                                                        className={`inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium ${consultationTypeClass(record.consultation_type)}`}
                                                    >
                                    ...
                                    <div className="mt-4 flex justify-end space-x-2">
                                        <button className="inline-flex items-center px-4 py-2 border border-primary text-sm font-medium rounded-md text-primary hover:bg-primary-lightest focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                            <Download
                                                size={16}
                                                className="mr-2"
                                            />
