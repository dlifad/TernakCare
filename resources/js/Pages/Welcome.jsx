        ...
        <>
            ...
            <div className="min-h-screen bg-neutral-lightest">
                    ...
                    <div className="container">
                        <div className="text-center">
                            ...
                            <p className="mt-3 max-w-md mx-auto text-base text-neutral-dark sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                                Konsultasi dengan dokter hewan terbaik, temukan
                                produk berkualitas, dan dapatkan informasi
                                ternak terbaru
                            </p>
                ...
                <div id="fitur" className="section">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center text-neutral-darkest mb-12 font-heading">
                            Layanan Utama Kami
                        </h2>
                ...
                <div className="section bg-white">
                    <div className="container">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-neutral-darkest font-heading">
                                Cara Kerja TernakCare
                            </h2>
                            <p className="mt-4 text-lg text-neutral">
                                Mudah dan cepat mendapatkan layanan untuk ternak
                                Anda
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-medium text-neutral-dark mb-2">
                                    Buat Akun
                                </h3>
                                <p className="text-neutral">
                                    Daftar dengan mudah dan lengkapi profil Anda
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-neutral">
                                    Konsultasi dokter, belanja produk, atau baca
                                    artikel
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-neutral">
                                    Nikmati layanan terbaik untuk kesehatan
                                    ternak Anda
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div className="lg:col-span-2">
                                <h2 className="text-2xl font-bold text-neutral-darkest mb-4 font-heading">
                                    Tentang TernakCare
                                </h2>
                                <p className="text-neutral mb-4">
                                    TernakCare adalah platform inovatif yang
                                    menghubungkan peternak dengan dokter hewan
                                    profesional, menyediakan akses ke
                                    marketplace produk peternakan berkualitas,
                                    dan menyajikan informasi terkini tentang
                                    kesehatan dan pengelolaan ternak.
                                </p>
                                <p className="text-neutral mb-4">
                                    Visi kami adalah menjadi platform terdepan
                                    dalam mendukung kesuksesan industri
                                    peternakan di Indonesia melalui teknologi
                ...
                <div className="section bg-neutral-light">
                    <div className="container">
                        <div className="text-center mb-12">
                            ...
                            <p className="mt-4 text-lg text-neutral">
                                Buka peluang baru dengan menjadi mitra dokter
                                hewan atau toko peternakan di TernakCare
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-soft text-center">
                                ...
                                <p className="text-neutral mb-6">
                                    Bergabunglah sebagai dokter hewan
                                    profesional dan bantu peternak di seluruh
                                    Indonesia dengan layanan konsultasi terbaik.
                                </p>
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-soft text-center">
                                <h3 className="text-xl font-bold text-neutral-darkest mb-4">
                                    Untuk Toko Peternakan
                                </h3>
                                <p className="text-neutral mb-6">
                                    Perluas jangkauan penjualan produk
                                    peternakan Anda dengan bergabung sebagai
                                    mitra toko di platform kami.
                                </p>
                        ...
                        <div className="text-center">
                            <h2 className="text-3xl font-extrabold text-white sm:text-4xl font-heading">
                                <span className="block">
                                    Siap bergabung dengan TernakCare?
                                </span>
                            </h2>
                            <p className="mt-4 text-lg leading-6 text-white opacity-90">
                                Daftar sekarang untuk mengakses semua layanan
                                kami
                            </p>
                            <div className="mt-8 flex justify-center space-x-4">
                                <Link href={route("register")}>
