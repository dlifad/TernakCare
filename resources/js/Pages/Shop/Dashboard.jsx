        ...
        <ShopLayout user={auth.user}>
            ...
            <div className="py-6">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-2xl font-heading font-semibold text-neutral-darkest mb-6">
                        Dashboard Toko
                    </h1>
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                                {statCards.map((stat, index) => (
                                    <Card
                                        key={index}
                                        className={`${stat.color} border-none shadow-card`}
                                    >
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-neutral-darkest">
                                                    {stat.value}
                                                </p>
                                            </div>
                                            <div
                                                className={`p-3 rounded-full bg-white bg-opacity-50`}
                                            >
                                                <svg
                            ...
                            <div className="mb-6">
                                <Card className="shadow-card">
                                    <div className="mb-4 flex justify-between items-center">
                                        <h2 className="text-lg font-heading font-semibold text-neutral-darkest">
                                            Transaksi Terbaru
                                        </h2>
                                        <a
                                    ...
                                    {stats.recentTransactions.length > 0 ? (
                                        <Table
                                            ...
                                            data={stats.recentTransactions.map(
                                                (tx) => [
                                                    `#${tx.id}`,
                                                    tx.farmer_name,
                                                    tx.product_count > 1
                                                        ? `${tx.main_product} +${tx.product_count - 1}`
                                                        : tx.main_product,
