...
export default function Dashboard() {
    ...
    const fetchTabData = async (tabId) => {
        ...
        try {
            ...
            setError(
                `Terjadi kesalahan saat mengambil data ${tabId}. Silakan coba lagi nanti.`,
            );
        } finally {
            setIsLoading(false);
        }
    ...
    const handleApproveUser = async (userId) => {
        try {
            ...
            setError(
                `Terjadi kesalahan saat menyetujui pengguna. Silakan coba lagi nanti.`,
            );
        }
    };
    ...
    const handleRejectUser = async (userId) => {
        try {
            ...
            setError(
                `Terjadi kesalahan saat menolak pengguna. Silakan coba lagi nanti.`,
            );
        }
    };
    ...
    const handleToggleStatus = async (userId) => {
        try {
            ...
            setError(
                `Terjadi kesalahan saat mengubah status pengguna. Silakan coba lagi nanti.`,
            );
        }
    };
                                            ...
                                            <div className="space-y-4">
                                                {currentItems.length > 0 ? (
                                                    ...
                                                    <div className="text-center py-8 text-neutral">
                                                        {searchTerm
                                                            ? "Tidak ada hasil yang ditemukan"
                                                            : "Tidak ada petani terdaftar saat ini"}
                                                    </div>
                                                )}
                                            </div>
                                            <Pagination />
                                            ...
                                            <div className="space-y-4">
                                                {currentItems.length > 0 ? (
                                                    ...
                                                    <div className="text-center py-8 text-neutral">
                                                        {searchTerm
                                                            ? "Tidak ada hasil yang ditemukan"
                                                            : "Tidak ada dokter terdaftar saat ini"}
                                                    </div>
                                                )}
                                            </div>
                                            <Pagination />
                                            ...
                                            <div className="space-y-4">
                                                {currentItems.length > 0 ? (
                                                    ...
                                                    <div className="text-center py-8 text-neutral">
                                                        {searchTerm
                                                            ? "Tidak ada hasil yang ditemukan"
                                                            : "Tidak ada toko terdaftar saat ini"}
                                                    </div>
                                                )}
                                            </div>
                                            <Pagination />
