    ...
    const navigation = [
        {
            ...
            current: window.location.pathname === "/doctor/dashboard",
        },
        {
            name: "Konsultasi",
            href: "/doctor/consultations",
            icon: Stethoscope,
            current: window.location.pathname === "/doctor/consultations",
        },
        {
            name: "Riwayat",
            href: "/doctor/history",
            icon: ClipboardList,
            current: window.location.pathname === "/doctor/history",
        },
        {
            name: "Profil",
            href: "/doctor/profile",
            icon: User,
            current: window.location.pathname === "/doctor/profile",
        },
    ];
                ...
                <div className="sticky top-0 z-10 bg-white shadow-soft h-16 flex items-center justify-between px-4 lg:px-8">
                    ...
                    <div className="flex items-center">
                        <div className="ml-3 relative">
                            <UserCircle
                                size={32}
                                className="text-neutral-dark cursor-pointer"
                            />
                        </div>
                    </div>
                </div>

                <main className="lg:pl-4">{children}</main>
            </div>
        </div>
    );
}
