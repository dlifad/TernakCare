    ...
    const navigation = [
        {
            ...
            current: window.location.pathname === "/shop/dashboard",
        },
        {
            name: "Kelola Produk",
        ...
        },
        {
            ...
            icon: ShoppingBag,
            current: window.location.pathname === "/shop/transactions",
        },
        {
            name: "Riwayat",
            href: "/shop/history",
            icon: ClipboardList,
            current: window.location.pathname === "/shop/history",
        },
        {
            name: "Profil Toko",
            href: "/shop/profile",
            icon: User,
            current: window.location.pathname === "/shop/profile",
        },
    ];
