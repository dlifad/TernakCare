...
const UserCard = ({ user }) => {
  ...
  const shouldDisplayCard = user.role === 'farmer' || user.status === 'verified';
      ...
      <div className="p-4">
        ...
        {user.specialty && (
          <p className="mt-1 text-sm text-neutral">
            <span className="font-medium">Spesialisasi:</span> {user.specialty}
          </p>
        )}
        ...
        <div className="mt-4 flex flex-col items-end space-y-2">
          ...
          <div className="flex space-x-2">
            ...
            >
              {isLoading ? 'Memproses...' : isActive ? 'Nonaktifkan' : 'Aktifkan'}
            </button>
