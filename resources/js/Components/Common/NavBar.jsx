...
export default function NavBar({ openSidebar, userRole }) {
    ...
    const notifications = [
        {
            id: 1,
            message: "Konsultasi dengan Dr. Andi telah dijadwalkan",
            time: "5 menit yang lalu",
            unread: true,
        },
        {
            id: 2,
            message: "Pesanan produk pakan ternak telah dikirim",
            time: "2 jam yang lalu",
            unread: false,
        },
        {
            id: 3,
            message: "Artikel baru tentang kesehatan ternak",
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                />
                                <span className="ml-2 text-sm text-neutral-dark hidden md:block">
                                    Budi Santoso
                                </span>
                                <Menu
                                    className="ml-1 text-neutral-dark"
                                    size={16}
                                />
                            </button>
