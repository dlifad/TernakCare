...
export default function Button({
    ...
    const baseClasses =
        "inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md font-medium focus:outline-none transition ease-in-out duration-150";
    ...
    const variantClasses = {
        ...
        outline:
            "bg-transparent hover:bg-gray-50 text-primary border border-primary",
    };
